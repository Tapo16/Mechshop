...
//                 <Link to="/"><li class="mr-5 hover:text-gray-900 cursor-pointer">Home</li></Link>
...
//             {
//               isOpen ? <div>
//                 <ul class="flex flex-col gap-10 text-2xl absolute top-[73px] left-0 h-screen w-full z-10  bg-[#807575] text-white items-center justify-center font-semibold">
//                   <Link to="/">
//                     <li class="mt-5 hover:text-gray-900 cursor-pointer">Home</li>
//                   </Link>
//                   <li class="mt-5 hover:text-gray-900 cursor-pointer">All Products</li>
//                   <li class="mt-5 hover:text-gray-900 cursor-pointer">Mens</li>
//                   <li class="mt-5 hover:text-gray-900 cursor-pointer">Kids</li>
//                 </ul>
//                 <button class="absolute top-[75px] z-10 right-0 text-white py-2 px-4 cursor-pointer"><RxCross2 size={30} /></button>
//               </div>:""

//              }

//             <div class="flex justify-center items-center gap-3">
//               <button class="bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base font-semibold">
//                 Login
//               </button>
//               <Link to='cart'>
//                 <button><FaCartShopping size={25} />
//                 </button>
//               </Link>
//               <button class="md:hidden" onClick={ToggleChange}>
        ...
        <header className="bg-white border-b border-gray-200 relative">
          <div className="container mx-auto flex justify-between p-5 items-center">
            ...
            <div className="flex justify-center items-center gap-3">
              ...
              <Link to='/cart'>
                <button><FaCartShopping size={25} /></button>
              </Link>
              {
