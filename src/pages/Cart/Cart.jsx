					...
					<div className="flex flex-col lg:flex-row shadow-md my-10">
						<div className="w-full lg:w-3/4 bg-white px-10 py-10">
							<div className="flex justify-between border-b pb-8">
								...
								<h2 className="font-semibold text-2xl uppercase">{cart.length} Items</h2>
							</div>
									...
									<div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={cartItem.id}>
										<div className="flex w-2/5">
											...
											<div className="flex flex-col justify-between ml-4 flex-grow">
												<span className="font-bold text-sm">{cartItem.title} Rs.</span>
						...
						<div id="summary" className="w-full lg:w-1/4 px-8 py-10 bg-[#f6f6f6]">
							...
							<div className="py-10">
								...
								<br />
								{
									promocode === "DISCOUNT10" && (<span className="text-[green]">Promo Code apply Successfully!</span>)
								}
							</div>
